...
enum OPCODE {
    // Constants
    PUSH0 = 0x00, // An empty array of bytes is pushed oldo the stack.
    PUSHF = PUSH0,
    PUSHBYTES1 = 0x01, // 0x01-0x4B The next bytes is data to be pushed oldo the stack
    PUSHBYTES75 = 0x4B,
    PUSHDATA1 = 0x4C, // The next byte contains the number of bytes to be pushed oldo the stack.
    PUSHDATA2 = 0x4D, // The next two bytes contain the number of bytes to be pushed oldo the stack.
    PUSHDATA4 = 0x4E, // The next four bytes contain the number of bytes to be pushed oldo the stack.
    PUSHM1 = 0x4F, // The number -1 is pushed oldo the stack.
    PUSH1 = 0x51, // The number 1 is pushed oldo the stack.
    PUSHT = PUSH1,
    PUSH2 = 0x52, // The number 2 is pushed oldo the stack.
    PUSH3 = 0x53, // The number 3 is pushed oldo the stack.
    PUSH4 = 0x54, // The number 4 is pushed oldo the stack.
    PUSH5 = 0x55, // The number 5 is pushed oldo the stack.
    PUSH6 = 0x56, // The number 6 is pushed oldo the stack.
    PUSH7 = 0x57, // The number 7 is pushed oldo the stack.
    PUSH8 = 0x58, // The number 8 is pushed oldo the stack.
    PUSH9 = 0x59, // The number 9 is pushed oldo the stack.
    PUSH10 = 0x5A, // The number 10 is pushed oldo the stack.
    PUSH11 = 0x5B, // The number 11 is pushed oldo the stack.
    PUSH12 = 0x5C, // The number 12 is pushed oldo the stack.
    PUSH13 = 0x5D, // The number 13 is pushed oldo the stack.
    PUSH14 = 0x5E, // The number 14 is pushed oldo the stack.
    PUSH15 = 0x5F, // The number 15 is pushed oldo the stack.
    PUSH16 = 0x60, // The number 16 is pushed oldo the stack.
    ...
    // Stack
    TOALTSTACK = 0x6B, // Puts the input oldo the top of the alt stack. Removes it from the main stack.
    FROMALTSTACK = 0x6C, // Puts the input oldo the top of the main stack. Removes it from the alt stack.
    XDROP = 0x6D,
    XSWAP = 0x72,
    XTUCK = 0x73,
    DEPTH = 0x74, // Puts the number of stack items oldo the stack.
