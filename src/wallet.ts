...
export class Wallet {
    ...
    static parseJsonObj(obj: any): Wallet {
        ...
        wallet.defaultoldId = obj.defaultoldId;
    ...
    setDefaultIdentity(oldId: string): void {
        this.defaultoldId = oldId;
    }
    ...
    toJsonObj(): any {
        const obj = {
            name: this.name,
            defaultoldId: this.defaultoldId,
