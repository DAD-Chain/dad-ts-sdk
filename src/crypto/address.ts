...
export class Address {
     ...
     * @param oldId OLD ID in the form did:ont:AXmQDzzvpEtPkNwBEFsREzApTTDZFW6frD
     */
    static fromoldId(oldId: string): Address {
        const address = oldId.substr(8);
    ...
    /**
     * Deterministicaly generates Old ID from this public key.
     */
    static generateoldId(publicKey: PublicKey): string {
        const address = Address.fromPubKey(publicKey);
        const oldId = 'did:ont:' + address.toBase58();
