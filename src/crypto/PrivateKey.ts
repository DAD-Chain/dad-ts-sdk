...
import { DEFAULT_ALGORITHM, DEFAULT_SM2_ID, OLD_BIP44_PATH } from '../consts';
...
export class PrivateKey extends Key {
   ...
   */
     ...
     *
     */
    static generateFromMnemonic(mnemonic: string, derivePath: string = OLD_BIP44_PATH): PrivateKey {
