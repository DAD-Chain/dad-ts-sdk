...
// Dad://nativeMethod?param1=xxx&param2=yyy
export const WEBVIEW_SCHEME = 'Dad';
...
export const OLD_NETWORK = {
    MAIN: 'MainNet',
    TEST: 'TestNet'
};

export const TEST_OLD_URL = {
